...
const promptComposerPath = path.join(
  root,
  "src/composables/prompt/usePromptComposer.js"
);
const textareaPath = path.join(
  root,
  "src/components/prompt/controls/PromptTextarea.vue"
);
const desktopToolbarPath = path.join(
  root,
  "src/components/prompt/controls/PromptToolbarDesktop.vue"
);
const mobileToolbarPath = path.join(
  root,
  "src/components/prompt/controls/PromptToolbarMobile.vue"
);
const studioPreviewPath = path.join(
  root,
  "src/components/studio/StudioPreview.vue"
);
...
assert(
  composer.includes("get submitDisabled()") &&
    composer.includes("componentProps.submitDisabled"),
