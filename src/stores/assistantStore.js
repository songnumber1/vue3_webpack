...
export const useAssistantStore = defineStore('assistant', {
  ...
  getters: {
    currentAssistant: (state) => state.assistantMap[state.selectedAssistantId] || state.assistants[0] || null,
    currentModels: (state) => state.modelMapByAssistant[state.selectedAssistantId] || [],
  ...
  actions: {
    setBootstrapData(payload = {}) {
      ...
      this.selectedModelId = payload.initialModelId || this.currentModels[0]?.id || ''
    },
    selectAssistant(id) {
