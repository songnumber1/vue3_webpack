...
export const CHAT_HISTORY_LIST_RAW = [
  ...
  {
    chatTitle: "duo 연관 링크 컴포넌트 테스트",
    chatId: "chat-mock-duo-only",
    modeId: "model-ds-rag",
    modelId: "model-ds-rag",
    bookmarkYN: false,
    dayGroup: 9,
    chatEndDt: "2026-05-05T15:00:00Z",
    userId: "user-1234",
    sharedId: null,
  },
  {
    chatTitle: "ragimage 연관 이미지 컴포넌트 테스트",
    chatId: "chat-mock-ragimage-only",
    modeId: "model-ds-rag",
    modelId: "model-ds-rag",
    bookmarkYN: false,
    dayGroup: 9,
    chatEndDt: "2026-05-05T15:10:00Z",
    userId: "user-1234",
    sharedId: null,
  },
  {
    chatTitle: "duo와 ragimage 동시 출력 테스트",
    chatId: "chat-mock-duo-ragimage",
    modeId: "model-ds-rag",
    modelId: "model-ds-rag",
    bookmarkYN: false,
    dayGroup: 9,
    chatEndDt: "2026-05-05T15:20:00Z",
    userId: "user-1234",
    sharedId: null,
  },
];
