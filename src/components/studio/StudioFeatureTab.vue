<template>
  <div class="studio-form-stack studio-feature-tab tw-grid tw-min-w-0 tw-gap-3">
    <fieldset
      class="studio-model-fieldset tw-m-0 tw-grid tw-min-w-0 tw-gap-2 tw-border-0 tw-bg-transparent tw-p-0"
    >
      <legend
        class="tw-mb-2 tw-block tw-p-0 tw-text-sm tw-font-extrabold tw-leading-snug tw-text-studio-text"
      >
        {{ t("studio.feature.model") }}
      </legend>
      <div
        class="studio-model-grid tw-grid tw-min-w-0 tw-grid-cols-1 tw-gap-2 tw-border-0 tw-bg-transparent"
      >
        <label
          ...
          :class="[
            'studio-check-row studio-model-card tw-grid tw-min-h-[56px] tw-min-w-0 tw-cursor-pointer tw-grid-cols-[24px_minmax(0,1fr)] tw-items-center tw-gap-2.5 tw-rounded-studio tw-border tw-border-solid tw-border-studio-border tw-bg-studio-surface tw-px-3 tw-py-2.5',
            {
              ...
              'tw-border-studio-primary tw-bg-studio-primary-soft':
        ...
        >
          ...
          <span class="tw-grid tw-min-w-0 tw-gap-1">
            ...
            <small class="tw-text-xs tw-leading-snug tw-text-studio-muted">{{
              model.description
            }}</small>
          </span>
        </label>
    ...
    <section
      class="studio-multi-select-field tw-grid tw-min-w-0 tw-gap-2"
      :aria-label="t('studio.feature.rag')"
    >
      <strong
        class="studio-field-title tw-block tw-text-sm tw-font-extrabold tw-leading-snug tw-text-studio-text"
        >{{ t("studio.feature.rag") }}</strong
      >
      <StudioMultiSelect
    ...
    <section
      class="studio-multi-select-field tw-grid tw-min-w-0 tw-gap-2"
      :aria-label="t('studio.feature.mcp')"
    >
      <strong
        class="studio-field-title tw-block tw-text-sm tw-font-extrabold tw-leading-snug tw-text-studio-text"
        >{{ t("studio.feature.mcp") }}</strong
      >
      <StudioMultiSelect
