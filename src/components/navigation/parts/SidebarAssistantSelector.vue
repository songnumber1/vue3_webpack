  ...
  <div ref="rootRef" class="assistant-selector">
    ...
    <div v-if="open && !mobile" class="assistant-menu">
      ...
      >
        ...
        <span v-if="assistant.id === selectedAssistantId" class="option-selected-indicator" aria-label="현재 선택된 값">
...
const currentAssistant = computed(
  () => props.assistants.find((item) => item.id === props.selectedAssistantId) || props.assistants[0] || {label: 'Assistant'}
);
