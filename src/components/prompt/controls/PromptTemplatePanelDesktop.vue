<template>
  ...
  >
    <div
      class="prompt-template-desktop-options tw-flex tw-w-full tw-min-w-0 tw-items-center tw-gap-[10px] tw-overflow-x-auto tw-overflow-y-hidden tw-pb-[2px] tw-[scrollbar-width:none] [&::-webkit-scrollbar]:tw-hidden"
    >
      <div
