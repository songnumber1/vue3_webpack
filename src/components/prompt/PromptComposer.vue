...
@description Shared prompt composer base. DesktopPromptInput and MobilePromptInput wrap this component so browser-specific layout can evolve independently from core submit/attachment logic.
@author OpenAI
-->
