<template>
  <div
    :class="['resource-detail-content', 'tw-flex-1 tw-min-h-0', contentClass]"
  >
    <header :class="[headClass, 'tw-flex tw-items-center tw-gap-4']">
      ...
      <div class="tw-min-w-0">
        <h2
          class="tw-m-0 tw-text-xl tw-font-black tw-leading-tight tw-text-studio-text"
        >
          {{ title }}
        </h2>
        <p
          class="tw-mt-1 tw-mb-0 tw-text-sm tw-leading-relaxed tw-text-studio-muted"
        >
          {{ meta }}
        </p>
      </div>
    ...
    <p
      ...
      :class="[
        descriptionClass,
        'tw-mt-4 tw-mb-0 tw-leading-relaxed tw-text-studio-muted',
      ]"
    >
      {{ description }}
    </p>

    <h3 class="tw-mt-5 tw-mb-2 tw-text-sm tw-font-black tw-text-studio-text">
      {{ labels.prompts }}
    </h3>
    ...
    <p :class="[boxClass, 'tw-m-0 tw-leading-relaxed tw-text-studio-muted']">
      {{ knowledge }}
    </p>
...
defineProps({
  ...
  headClass: {
    ...
    default: "resource-detail-content__head",
  },
  imageClass: {
    type: [String, Array, Object],
    default: "resource-detail-content__image",
  },
  descriptionClass: {
    type: [String, Array, Object],
    default: "resource-detail-content__description",
  },
  promptGridClass: {
    type: [String, Array, Object],
    default: "resource-detail-content__prompt-grid",
  },
  boxClass: {
    type: [String, Array, Object],
    default: "resource-detail-content__box",
  },
});
</script>
